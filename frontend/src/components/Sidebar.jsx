...
const Sidebar = ({ onClose, open }) => {
  ...
  return (
    <>
      <div
        className={`${
          open ? "w-screen md:w-lg h-screen p-10" : "w-0 h-0"
      ...
      >
        <div className="h-full space-y-3">
          <div className="flex justify-between">
            ...
            <button
              className="flex justify-between items-center border rounded-2xl p-2 border-[#eeeeee] hover:bg-[#f4f4f4] active:bg-[#d6d6d6]"
              onClick={onClose}
            >
              <X className="size-6" />
            </button>
